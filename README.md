...
* `ChangeAllRegistryKeysByRegex.ps1` changes all registry keys and values according to a given regex pattern and replacement. This really takes a while to run and will not work for everything! Also, it can *severely* damage your Windows install if used wrongly. **Use with caution!**
